  ...
  .then(function(fileTree) {
    ...
    .then(function() {
      ...
      coreDeps.sort().forEach(function(dep) {
        if (packageConfig.map && packageConfig.map[dep] || packageConfig.peerDependencies[dep] || packageConfig.dependencies[dep])
          return;
        
        packageConfig.peerDependencies[dep] = nodelibsPathPrefix + dep + nodelibsVersion;   
      });
