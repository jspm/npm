...
exports.convertPackage = function(packageConfig, packageName, packageDir, ui) {
  ...
  var dirFilter = ['!node_modules', '!.git'];
  if (packageConfig.files instanceof Array)
    dirFilter = packageConfig.files;
  else if (packageConfig.ignore instanceof Array)
    dirFilter = dirFilter.concat(packageConfig.ignore.map(function(ignore) {
      return '!' + ignore;
    }));
