  ...
  .then(function(fileTree) {
    ...
    .then(function() {
      ...
      coreDeps.sort().forEach(function(dep) {
        if (systemConfig.map && systemConfig.map[dep] || systemConfig.peerDependencies && systemConfig.peerDependencies[dep] || systemConfig.dependencies && systemConfig.dependencies[dep])
          return;
