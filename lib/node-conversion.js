...
exports.convertPackage = function(pjson, dir, ui) {
  ...
  .then(function(fileTree) {
    ...
    // format
    packageConfig.format = systemConfig.format || 'cjs';
      ...
      .then(function(parsed) {
        ...
        if (meta) {
          ...
          for (var i = 1; i < pathParts.length; i++) {
            ...
            if (curCommonParsed.format && curCommonParsed.format != format)
        ...
        if (map && format == 'cjs' && fileName.substr(fileName.length - 9, 9) == '/index.js' && !fileTree[fileName.substr(0, fileName.length - 9) + '.js'])
